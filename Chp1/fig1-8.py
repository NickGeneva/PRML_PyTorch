...
if __name__ == '__main__':
    ...
    f.suptitle('Figure 1.8, pg. 11', fontsize=14)

    X_train, T_train = generateData(1, 10, 0.3) #Generate training data
    X_test, T_test = generateData(1, 100, 0) #Generate test set date
